...
-- ============================================================
-- KRAVON V11 CONSOLIDATED SCHEMA
-- PostgreSQL 17
-- Merge of:
--   V8 Core Platform
--   V9 SaaS Infrastructure
--   V10 Enterprise Extensions
-- ============================================================
...
-- ============================================================
-- V10 ENTERPRISE EXTENSIONS (merged into V11)
-- ============================================================

-- Billing ledger for metered SaaS billing
...
ON platform.events(entity_type, entity_id);
...
ON insights.customer_events(tenant_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_customer_events_customer
ON insights.customer_events(customer_id);

-- Inventory stock derived view
...
ADD CONSTRAINT IF NOT EXISTS uq_api_key_hash UNIQUE(key_hash);

-- Performance indexes
CREATE INDEX IF NOT EXISTS idx_inventory_movements_tenant_created
ON inventory.movements(tenant_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_menu_views_session
ON insights.menu_views(session_id);

-- ============================================================
-- END OF V11 ENTERPRISE MERGE
-- ============================================================
