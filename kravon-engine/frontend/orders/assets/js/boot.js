...
(async () => {
  ...
  try {
    ...
    if (typeof OrdersCart !== 'undefined' && typeof OrdersCart.init === 'function') {
      OrdersCart.init();
    }
    if (typeof window.initOrdersRenderer === 'function') {
      window.initOrdersRenderer();
    }
    if (typeof OrdersModal !== 'undefined' && typeof OrdersModal.init === 'function') {
      OrdersModal.init();
    }
    if (typeof OrdersCheckout !== 'undefined' && typeof OrdersCheckout.init === 'function') {
      OrdersCheckout.init();
    }
    if (typeof window.initOrdersBehaviour === 'function') {
